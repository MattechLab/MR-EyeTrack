...
expName = 'mreyetrack_16points'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/c:/Users/jaime.barranco/Desktop/repos/mattechlab/MR-EyeTrack/visual_stimuli/mreyetrack_16points.py',
