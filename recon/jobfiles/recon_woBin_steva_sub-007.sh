#!/bin/bash
#SBATCH --job-name=mreyetrack_recon_sub-007
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
MATLAB_CMD="addpath(genpath('/usr/src/app')); compile_mex_for_monalisa; run('/usr/src/app/scripts/jobfiles/S4_recon_chacha_4fr_woBin_pulseq_sub_007.m');"
