...
if nargin < 3 || isempty(mapVBVD_path)
    mapVBVD_path = '/Users/mauroleidi/Desktop/MattechGit/flexyphy_paper_folder/reconstruction_and_results/mapVBVD';
end
if nargin < 4 || isempty(pulseq_path)
    pulseq_path  = '/Users/mauroleidi/Desktop/MattechGit/pulseSeqYiwei/pulseq';
end
