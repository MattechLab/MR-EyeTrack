% =====================================================
% Batch binning script — blink_event mask
% Based on S2_eyeMask_t1_binning_pulseq_batch_nomo.m
% Runs subjects 1-15, mask_type 'blink-event'.
...
for subject_num = 1:15
    ...
    maskFiles = dir(fullfile(ETDir, '*_blink_event_mask.mat'));
    ...
    fprintf('  [blink_event] preserved: %d / %d readouts\n', sum(binMaskVec), NLin);
...
disp('Batch blink_event binning complete.');
