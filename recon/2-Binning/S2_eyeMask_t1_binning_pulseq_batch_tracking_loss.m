% =====================================================
% Batch binning script — tracking_loss mask
% Based on S2_eyeMask_t1_binning_pulseq_batch_nomo.m
% Runs subjects 1-15, mask_type 'tracking-loss'.
...
for subject_num = 1:15
    ...
    maskFiles = dir(fullfile(ETDir, '*_tracking_loss_mask.mat'));
    ...
    fprintf('  [tracking_loss] preserved: %d / %d readouts\n', sum(binMaskVec), NLin);
...
disp('Batch tracking_loss binning complete.');
