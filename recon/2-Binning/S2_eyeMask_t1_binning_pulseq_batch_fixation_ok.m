% =====================================================
% Batch binning script — fixation_ok mask
% Based on S2_eyeMask_t1_binning_pulseq_batch_nomo.m
% Runs subjects 1-15, mask_type 'fixation-ok'.
...
for subject_num = 1:15
    ...
    maskFiles = dir(fullfile(ETDir, '*_fixation_ok_mask.mat'));
    ...
    fprintf('  [fixation_ok] preserved: %d / %d readouts\n', sum(binMaskVec), NLin);
...
disp('Batch fixation_ok binning complete.');
