...
% Variables
subject_num = 3;
nChCompressed = 10;  % Number of virtual coils after compression
coilCompression = 2;  % 0: SVD-based compression; 1: coil selection based on energy; 2: coil selection with eye ROIs
...
elseif coilCompression == 2
    ...
    weights_norm = coilSelectionEyesROI(reconDir);

    % Save weights_norm on the base mDir folder
    weights_path = fullfile(fileparts(mDir), 'weights_norm.mat');
    ...
    idx_path = fullfile(fileparts(mDir), 'idx_coilSelection.mat');
