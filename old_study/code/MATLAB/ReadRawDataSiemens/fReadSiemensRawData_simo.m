function [twix_obj, rawData] = fReadSiemensRawData_simo( filepathRawData )
%--------------------------------------------------------------------------
%
...
%     twix_obj_multi = mapVBVD_FreeRunning(filepathRawData); % Cannot use this function because of counter overflow issue 
    twix_obj_multi = mapVBVDsimo(filepathRawData);
...
%     twix_obj = mapVBVDsimo(filepathRawData);
